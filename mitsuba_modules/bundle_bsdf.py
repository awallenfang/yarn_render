...
class BundleBSSRDF(mi.BSDF):
    def __init__(self, props):
        ...
        transmission_flags = mi.BSDFFlags.DeltaTransmission | mi.BSDFFlags.FrontSide
    ...
    def sample(self, ctx, si, sample1, sample2, active):
        ...
        # Set sampled type to delta reflection and delta transmission based on sample1 and passthrough chance
        # Randomly select outgoing direction in case of reflection
        pass
    ...
    def pdf(self, ctx, si, wo, active):
        # Sample pdf at specific position
        return 0.0
